...
export default function ProjectCard({ title, image, children }: ProjectCardProps) {
  return (
    <div className="shrink-0 w-full md:w-[600px] aspect-square flex flex-col border-[3px] border-foreground overflow-hidden transition-all duration-300 hover:bg-foreground hover:text-background group select-none">
