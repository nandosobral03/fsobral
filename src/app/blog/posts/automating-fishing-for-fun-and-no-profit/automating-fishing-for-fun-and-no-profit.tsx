  ...
  return (
    <>
      ...
      <Section>
        ...
        {/* IMAGE OF THE GAME WHILE CATCHING HERE */}
        <Paragraph>
      ...
      <Section>
        ...
        <Paragraph>
          This process took some time but eventually I implemented the logic to
          move to the store and to three different fishing spots which should be
          able to cover all fishing pools
        </Paragraph>
        {/* VIDEO OF RUNNING TO THE DIFFERNETLOCATIONS */}
        <Paragraph>
        ...
        {/* VIDEO OF SETTING UP THE FISHING BUDDIES */}
        <Paragraph>
        ...
        <Paragraph>
          More idleing attempts, more fish, and the script was making good
          progress on the journal. I had already reached max level and bought
          all upgrades in about 50 or so hours of idleing. I decided to make
      ...
      <Section>
        ...
        <Paragraph>
          ...
          is some sense of acomplishment in knowing I 100% completed the game
