...
const unsortedPostEntries: PostMetadata[] = [
  {
...
export const postEntries = sortContentByDate(unsortedPostEntries);

export const postsMetadata = postEntries;

export function getPostMetadata(slug: string) {
  return getContentBySlug(postEntries, slug);
}

export function getVisiblePostMetadata() {
  return getVisibleContent(postEntries);
}
import { getContentBySlug, getVisibleContent, sortContentByDate } from "@/lib/content-collection";
