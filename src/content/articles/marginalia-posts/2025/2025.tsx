import { Section, Paragraph, List, Divider, Quote } from "@/components/article/blocks/blog-section";
import TimelineProgress, { TimelineSection } from "@/components/article/blocks/timeline-progress";
