...
export const entries: ChangelogEntry[] = [
  ...
  {
    date: "2026-05-15",
    description: "Moved project year groups and sitemap dates into content surfaces",
    tag: "improved",
  },
  {
    date: "2026-05-15",
    description: "Moved authored content behind deep content collection modules",
    tag: "improved",
  },
  {
    date: "2026-05-14",
